    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_3283 = 1.0;
                clip((lerp((node_5403_if_leA*0.0)+(node_5403_if_leB*node_3283),node_3283,node_5403_if_leA*node_5403_if_leB)*_Alpha02_Bright) - 0.5);
////// Lighting:
////// Emissive:
